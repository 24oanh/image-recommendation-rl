...
|---|---|---|
| **State** | Agent đang "thấy gì" | Mean pooling K=5 image feature vectors của K items user appreciate gần nhất → vector 512-dim |
| **Action** | Agent có thể "làm gì" | Chọn 1 item trong candidate pool2000 items |
